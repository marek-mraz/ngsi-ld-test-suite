*** Settings ***
Documentation       Check that one can query the temporal evolution of entities matching the given id pattern
...
${expectation_file}=                vehicles-temporal-representation-021-07.jsonld


*** Test Cases ***
021_07_01 Query The Temporal Evolution Of Entities Matching The Given Id Pattern
    [Documentation]    Check that one can query the temporal evolution of entities matching the given id pattern
    [Tags]    te-query    5_7_4
    ...
    ...    entity_id_pattern=urn:ngsi-ld:Vehicle:.*
    ...    timerel=after
...
Setup Initial Temporal Entities
    ${first_temporal_entity_representation_id}=    Catenate    ${VEHICLE_ID_PREFIX}021-07-A
    ...
    ${second_temporal_entity_representation_id}=    Catenate    ${VEHICLE_ID_PREFIX}021-07-B
