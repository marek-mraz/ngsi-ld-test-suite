*** Settings ***
Documentation       Check that a notification is sent with sysAttrs when an entity is deleted
...
*** Variables ***
${subscription_payload_file_path}=      subscriptions/subscription-building-entities-entityDeleted-sysAttrs.jsonld
