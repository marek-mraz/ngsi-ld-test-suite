*** Settings ***
Documentation       Check that a notification is sent in normalized format when an attribute with a specific datasetId is deleted
...
*** Test Cases ***
046_22_06 Check That A Notification Is Sent With Matching Entity
