*** Settings ***
Documentation       Check that a notification is sent in normalized format when an attribute is deleted via NGSI-LD Null
...                 in a Merge Entity operation and attributeDeleted notification trigger is configured for this specific attribute
...
${entity_expectation_file_path}=        entity-different-attributes-types-deleted-name-attribute-normalized.json
...
046_22_09_01 Check That A Notification Is Sent With Matching Entity When Deleting Via Merge Entity Operation
    ...
    ...    entity_id=${entity_id}
    ...    entity_filename=fragmentEntities/ngsild-null/building-null-property.jsonld
...
046_22_09_02 Check That A Notification Is Sent With Matching Entity When Deleting Via Update Attributes Operation
    ...
    ...    id=${entity_id}
    ...    fragment_filename=ngsild-null/null-property.jsonld
    ...    content_type=${CONTENT_TYPE_LD_JSON}
    Check Response Status Code    204    ${response.status_code}
...
046_22_09_03 Check That A Notification Is Sent With Matching Entity When Deleting Via Partial Attribute Update Operation
    ...
    ...    entityId=${entity_id}
    ...    attributeId=name
    ...    fragment_filename=ngsild-null/null-property-fragment.jsonld
    ...    content_type=${CONTENT_TYPE_LD_JSON}
    Check Response Status Code    204    ${response.status_code}
