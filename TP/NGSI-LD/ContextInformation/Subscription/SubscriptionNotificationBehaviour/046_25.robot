*** Settings ***
Documentation       Check that a notification is sent with flat linked entity in simplified format when linking entity is updated
...
${subscription_payload_file_path}=      subscriptions/subscription-building-entities-join-flat-simplified.jsonld
${fragment_filename}=                   name-fragment.jsonld
${entity_expectation_file_path}=        entity-created-name-attribute-join-flat-simplified.json
