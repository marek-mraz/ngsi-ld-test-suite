*** Settings ***
Documentation       Check that a notification is sent with inline linked entity with sysAttrs when linking entity is updated
...
${subscription_payload_file_path}=      subscriptions/subscription-building-entities-join-inline-sysAttrs.jsonld
${fragment_filename}=                   name-fragment.jsonld
${entity_expectation_file_path}=        entity-created-name-attribute-join-inline-sysAttrs.json
