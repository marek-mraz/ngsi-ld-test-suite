*** Settings ***
Documentation       Check that a notification is sent with inline linked entity in simplified format when linking entity is updated
...
${subscription_payload_file_path}=      subscriptions/subscription-building-entities-join-inline-simplified.jsonld
${fragment_filename}=                   name-fragment.jsonld
${entity_expectation_file_path}=        entity-created-name-attribute-join-inline-simplified.json


*** Test Cases ***
046_29_01 Check That A Notification Is Sent With Inline Linked Entity In Simplified Format
    [Documentation]    Create an attribute in linking entity and check the notification contains linked entity in simplified format
