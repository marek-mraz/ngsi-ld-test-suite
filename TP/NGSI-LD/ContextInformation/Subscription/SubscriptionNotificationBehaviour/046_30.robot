*** Settings ***
Documentation       Check that a notification is sent with inline linked entity and selected attributes when linking entity is updated
...
${subscription_payload_file_path}=      subscriptions/subscription-building-entities-join-inline-attributes.jsonld
${fragment_filename}=                   name-fragment.jsonld
${entity_expectation_file_path}=        entity-created-name-attribute-join-inline-attributes.json


*** Test Cases ***
046_30_01 Check That A Notification Is Sent With Inline Linked Entity And Selected Attributes
    [Documentation]    Create an attribute in linking entity and check the notification contains linked entity with selected attributes
