*** Settings ***
Documentation       Check that if one request the Context Broker to delete an attribute without the deleteAll flag nor a datasetId, the default Attribute instance is deleted in the Context Source.
...
*** Test Cases ***
D006_01_exc Delete Entity Attributes
