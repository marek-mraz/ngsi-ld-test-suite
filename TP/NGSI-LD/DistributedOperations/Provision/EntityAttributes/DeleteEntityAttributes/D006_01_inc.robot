*** Settings ***
Documentation       Check that if one request the Context Broker to delete an attribute without the deleteAll flag nor a datasetId, the default Attribute instance is deleted.
